                ...
                <div className='flex justify-center'>
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-center space-y-4 sm:space-y-0 sm:space-x-10 w-full sm:w-1/2 p-4">
                        <div className="flex flex-col items-start space-y-2">
                            ...
                            <p className="text-lg transition-colors hover:text-customRed"><a href="tel:6056416269">(605) 641-6269</a></p>
                        </div>
                        <div className="flex flex-col items-start space-y-2">
                    ...
                    <div className="w-1/2 h-full">
                        <img src="team-roping.jpg" alt="Description of the image" className="w-full h-full object-cover" />
                    </div>
                </div>
            </div>
        </div>
